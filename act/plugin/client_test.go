...
func (d *delegateServer) Create(context.Context, *pluginv1.CreateRequest) (*pluginv1.CreateResponse, error) {
...
func TestClient_CreateExecutionEnvironment_Delegate(t *testing.T) {
	...
	del, err := c.CreateExecutionEnvironment(t.Context(), &container.NewContainerInput{Image: "x", Name: "n"}, nil, false)
	require.NoError(t, err)
